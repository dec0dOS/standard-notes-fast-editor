...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    function onReceivedNote(note) {
        ...
        if (editor) {
            if (clientData) {
                fast_editor.setAllowLongerLinesNoRefresh(finalOptionAllowLongerLines());
                fast_editor.setColorHeaders(finalOptionColorHeaders());
                fast_editor.setMonospaceNoRefresh(finalOptionMonospace());
            }
    ...
    function loadEditor() {
        fast_editor = new FastEditor(document.getElementById("code"), finalOptions());
        editor = fast_editor.editor;
    ...
    window.changeAllowLongerLinesConfig = function (new_value) {
        ...
        fast_editor.setAllowLongerLines(finalOptionAllowLongerLines());
        save();
    }
    ...
    window.changeMonospaceConfig = function (new_value) {
        ...
        fast_editor.setMonospace(finalOptionMonospace());
        save();
    }
